...
public class SellerSeeOrderFrm extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
            	SellerSeeOrderFrm frame = new SellerSeeOrderFrm(null);
     ...
     * Create the frame.
     */
    public SellerSeeOrderFrm(String usename) {
        setTitle("查看订单信息");
    ...
    public void fillTable() {
        ...
        try (Connection con = jdbc.getConnection()) {
            ...
            ResultSet rs = orderDao.sellerSeeOrder(con, usename);
            while (rs.next()) {
