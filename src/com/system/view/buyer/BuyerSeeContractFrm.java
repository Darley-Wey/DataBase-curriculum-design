...
public class BuyerSeeContractFrm extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                BuyerSeeContractFrm frame = new BuyerSeeContractFrm(null);
     ...
     * Create the frame.
     */
    public BuyerSeeContractFrm(String usename) {
        setTitle("查看合同信息");
    ...
    public void fillTable() {
        ...
        try (Connection con = jdbc.getConnection()) {
            ResultSet rs = contractDao.buyerSeeContract(con, usename);
            while (rs.next()) {
